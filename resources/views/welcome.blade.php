...
<html lang="en">
<head>
<title>+2 Shiv Naryan Sarvodaya High School Bareta</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Shiv Naryan Sarvodaya High School Bareta,SNS High School Bareta">
...
<link href="{{asset('/')}}assets/plugins/video-js/video-js.css" rel="stylesheet" type="text/css">
...
<div class="super_container">
						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								<ul class="top_bar_contact_list">
									...
									<li>
										<div>info@snshighschool.com</div>
									</li>
								</ul>
							...
							<div class="logo_container">
								<a href="#">
									<div class="logo_content d-flex flex-row align-items-end justify-content-start">
										...
										<div class="logo_text">+2 SNS High School Bareta</div>
									</div>
								</a>
							</div>
		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item">
					...
					<div class="home_slider_background" style="background-image:url({{asset('/')}}assets/images/main_gate.jpg)"></div>
					<div class="home_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_content text-center">
										<div class="home_logo"><img src="{{asset('/')}}assets/images/home_logo.png" alt=""></div>
										<div class="home_text">
											<div class="home_title">SNS High School Bareta</div>
											<div class="home_subtitle">Education is the process of learning and passing on knowledge, skills, and values from one generation to another.</div>
										</div>
				...
				<div class="owl-item">
					<!-- Background image artist https://unsplash.com/@benwhitephotography -->
					<div class="home_slider_background" style="background-image:url({{asset('/')}}assets/images/School_team.jpeg)"></div>
					<div class="home_container">
						<div class="container">
							<div class="row">
								<div class="col">
				...
				<div class="owl-item">
					<!-- Background image artist https://unsplash.com/@benwhitephotography -->
					<div class="home_slider_background" style="background-image:url({{asset('/')}}assets/images/School.jpeg)"></div>
					<div class="home_container">
						<div class="container">
							<div class="row">
								<div class="col">
						...
						<div class="row">
							<div class="col-lg-6 featured_col">
								<div class="featured_content">
									...
									<div class="featured_title"><h3><a href="courses.html">SNS High School Bareta</a></h3></div>
									<div class="featured_text">Education is the process of learning and passing on knowledge, skills, and values from one generation to another.</div>
									<div class="featured_footer d-flex align-items-center justify-content-start">
										<div class="featured_author_image"><img src="{{asset('/')}}assets/images/featured_author.jpg" alt=""></div>
							...
							<div class="col-lg-6 featured_col">
								<div class="featured_background" style="background-image:url({{asset('/')}}assets/images/featured.jpg)"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col">
					...
					<div class="courses_slider_container">
						<div class="owl-carousel owl-theme courses_slider">
							...
							<div class="owl-item">
								<div class="course">
									...
									<div class="course_body">
										...
										<div class="course_title"><h3><a href="courses.html">SNS High School Bareta</a></h3></div>
										<div class="course_text">Education is the process of learning and passing on knowledge, skills, and values from one generation to another.</div>
										<div class="course_footer d-flex align-items-center justify-content-start">
											<div class="course_author_image"><img src="{{asset('/')}}assets/images/featured_author.jpg" alt="https://unsplash.com/@anthonytran"></div>
							...
							<div class="owl-item">
								<div class="course">
									<div class="course_image"><img src="{{asset('/')}}assets/images/course_3.jpg" alt="https://unsplash.com/@annademy"></div>
									<div class="course_body">
										<div class="course_header d-flex flex-row align-items-center justify-content-start">
											<div class="course_tag"><a href="#">Featured</a></div>
											<div class="course_price ml-auto">Price: <span>$35</span></div>
	...
	<div class="milestones">
		...
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{asset('/')}}assets/images/milestones.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row milestones_container">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{asset('/')}}assets/images/milestone_1.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{asset('/')}}assets/images/milestone_2.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{asset('/')}}assets/images/milestone_3.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{asset('/')}}assets/images/milestone_4.svg" alt=""></div>
				...
				<div class="col-lg-4 grouped_col">
					...
					<div class="news">
						...
						<div class="news_post d-flex flex-row align-items-start justify-content-start">
							<div><div class="news_post_image"><img src="{{asset('/')}}assets/images/news_1.jpg" alt="https://unsplash.com/@beccatapert"></div></div>
						...
						<!-- News Post -->
						<div class="news_post d-flex flex-row align-items-start justify-content-start">
							<div><div class="news_post_image"><img src="{{asset('/')}}assets/images/news_2.jpg" alt="https://unsplash.com/@nbb_photos"></div></div>
							<div class="news_post_body">
								<div class="news_post_date">April 02, 2018</div>
						...
						<!-- News Post -->
						<div class="news_post d-flex flex-row align-items-start justify-content-start">
							<div><div class="news_post_image"><img src="{{asset('/')}}assets/images/news_3.jpg" alt="https://unsplash.com/@rawpixel"></div></div>
							<div class="news_post_body">
								<div class="news_post_date">April 02, 2018</div>
								<div class="news_post_title"><a href="news.html">Why Choose online education?</a></div>
								<div class="news_post_author">By <a href="#">William Smith</a></div>
						...
						<!-- News Post -->
						<div class="news_post d-flex flex-row align-items-start justify-content-start">
							<div><div class="news_post_image"><img src="{{asset('/')}}assets/images/news_4.jpg" alt="https://unsplash.com/@jtylernix"></div></div>
							<div class="news_post_body">
								<div class="news_post_date">April 02, 2018</div>
								<div class="news_post_title"><a href="news.html">Books, Kindle or tablet?</a></div>
								<div class="news_post_author">By <a href="#">William Smith</a></div>
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_about">
						<div class="logo_container">
							<a href="#">
								<div class="logo_content d-flex flex-row align-items-end justify-content-start">
									<div class="logo_img"><img src="{{asset('/')}}assets/images/logo2.png" alt=""></div>
									<div class="logo_text">SNS</div>
								</div>
							</a>
						</div>
						<div class="footer_about_text">
							<p>Education is the process of learning and passing on knowledge, skills, and values from one generation to another.</p>
						</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Pawan Raj</a>
					...
					<div class="footer_contact">
						...
						<div class="footer_contact_info">
							<div class="footer_contact_item">
								...
								<div class="footer_contact_line">Bareta ,Falka , Katihar, Bihar</div>
							</div>
							<div class="footer_contact_item">
							...
							<div class="footer_contact_item">
								...
								<div class="footer_contact_line">info@snshighschool.com</div>
							</div>
						</div>
					</div>
				</div>
